...
//Last modified: Sat, Dec 07, 2019 02:31:53 AM
//Codeset: 1252
requires maya "2019";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -111.1641376797716 175.25702838867423 171.27517543140567 ;
	setAttr ".r" -type "double3" 328.46164727027548 337.7999999999069 -1.717602186334893e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "A659C2CF-4C01-9962-8ABB-77AE321779D8";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 351.02756987539681;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -0.17677888763998198 133.44254168734838 -4.9377553267004881e-06 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "8C65553A-4296-205B-D083-E4B846FFB1B3";
	setAttr -s 8 ".lnk";
	setAttr -s 9 ".ign";
	setAttr -s 8 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "0CD3A8B0-4D34-B677-40C4-A0BFBF1279EE";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "F3D9B957-4960-DA45-4CD4-B68BC02350D8";
createNode displayLayerManager -n "layerManager";
	rename -uid "FE2B56B9-4317-26F6-0871-28A887751A44";
createNode displayLayer -n "defaultLayer";
	rename -uid "BDAFE2CC-46FC-F1EE-1149-C28B675936F4";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "67241B8F-49F8-38E2-C2A6-BD990B9F87F7";
...
createNode colorConstant -n "_Lookdev_BG_ConstantColor";
	...
	setAttr "._c" -type "float3" 0.02 0.02 0.02 ;
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "62F2B9B2-483F-2150-525A-9EA8E0388275";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -806.38409801151761 -514.28569384983689 ;
	setAttr ".tgi[0].vh" -type "double2" 881.38409503128571 334.52379623102814 ;
	setAttr -s 3 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" 128.23529052734375;
	setAttr ".tgi[0].ni[0].y" 190;
	setAttr ".tgi[0].ni[0].nvs" 18306;
	setAttr ".tgi[0].ni[1].x" -102.85713958740234;
	setAttr ".tgi[0].ni[1].y" 277.14285278320313;
	setAttr ".tgi[0].ni[1].nvs" 18304;
	setAttr ".tgi[0].ni[2].x" -316.09835815429688;
	setAttr ".tgi[0].ni[2].y" -141.300537109375;
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "A946C5A6-412B-E336-62EB-3FBD890717B2";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -2219.6109324808626 -859.3349056656391 ;
	setAttr ".tgi[0].vh" -type "double2" -54.009282366438519 428.82469655759598 ;
	setAttr -s 8 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" -1455.1705322265625;
	setAttr ".tgi[0].ni[0].y" -219.44036865234375;
	setAttr ".tgi[0].ni[0].nvs" 1922;
	setAttr ".tgi[0].ni[1].x" -1878.6658935546875;
	setAttr ".tgi[0].ni[1].y" -276.6123046875;
	setAttr ".tgi[0].ni[1].nvs" 1923;
	setAttr ".tgi[0].ni[2].x" -1150.59521484375;
	setAttr ".tgi[0].ni[2].y" -142.55458068847656;
	setAttr ".tgi[0].ni[2].nvs" 2227;
	setAttr ".tgi[0].ni[3].x" -626.17156982421875;
	setAttr ".tgi[0].ni[3].y" -56.657211303710938;
	setAttr ".tgi[0].ni[3].nvs" 1923;
	setAttr ".tgi[0].ni[4].x" -1158.59619140625;
	setAttr ".tgi[0].ni[4].y" 343.20578002929688;
	setAttr ".tgi[0].ni[4].nvs" 2227;
	setAttr ".tgi[0].ni[5].x" -10;
	setAttr ".tgi[0].ni[5].y" -28.571428298950195;
	setAttr ".tgi[0].ni[5].nvs" 1923;
	setAttr ".tgi[0].ni[6].x" -318.08578491210938;
	setAttr ".tgi[0].ni[6].y" -28.571428298950195;
	setAttr ".tgi[0].ni[6].nvs" 1923;
	setAttr ".tgi[0].ni[7].x" -1561.5986328125;
	setAttr ".tgi[0].ni[7].y" 220.56340026855469;
...
connectAttr "_Lookdev_BG_Grid_Pattern.resultRGB" "_Lookdev_BG_GridLayer.diffuseColor"
		;
connectAttr "Lookdev_CamShape.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[0].dn"
		;
connectAttr "Lookdev_Cam.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[1].dn";
connectAttr "_Lookdev_BG_ConstantColor.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[2].dn"
		;
connectAttr "_Lookdev_BG_Grid_Pattern_Manifold_2D.result" "_Lookdev_BG_Grid_Pattern.manifold"
		;
connectAttr "_Lookdev_BG_Grid_Pattern.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[0].dn"
		;
connectAttr "_Lookdev_BG_Grid_Pattern_Manifold_2D.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[1].dn"
		;
connectAttr "_Lookdev_BG_GridLayer.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[2].dn"
		;
connectAttr "_Lookdev_BG_LayerMixer.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[3].dn"
		;
connectAttr "_Lookdev_BG_BaseLayer.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[4].dn"
		;
connectAttr "_Lookdev_BG_SG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[5].dn"
		;
connectAttr "_Lookdev_BG_LayerSurface.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[6].dn"
		;
